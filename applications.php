...
<body>
	...
	<div id="tg-wrapper" class="tg-wrapper tg-haslayout">
		...
		<main id="tg-main" class="tg-main tg-haslayout">
            ...
            <?php
            $i=1;
			$sql_query = "SELECT * FROM applications WHERE Status ='' "; 
			$resultset = $con->query($sql_query) or die("database error:". mysqli_error($con));
            $num_centres = $resultset->num_rows;
            ?>
                    <h1> <center>APPLICATIONS (<?php echo $num_centres ?>) <center></h1>
        ...
        <thead>
            <tr>
				...
				<th> Parents/Guardian Forum </th>
				<th> Management committee </th>
				<th> Statutory Annual Meeting </th>
				<th> Yearly Medical Examination  </th>
				<th> LongTerm Academy Development Program </th>
       ...
       <tbody>
			...
			?>
			   ...
			   <td>
			   <?php 
			    if($developer->ParentsForum !='')   
			    {
			        
			    
			   ?>
			       <a href="<?php echo $developer->ParentsForum;?>"> <i class="fa fa-file-image-o" style="font-size:32px;"></i></a>
			   <?php
			    }
			    else
			    {
			   ...
			   <td>
			   <?php 
			    if($developer->ManagementCommittee !='')   
			    {
			         
			    
			   ?>
			       <a href="<?php echo $developer->ManagementCommittee;?>"> <i class="fa fa-file-image-o" style="font-size:32px;"></i></a>
			   <?php
			    }
			    else
			    {
			   ...
			   <td>
			   <?php 
			    if($developer->StatutoryAnnualMeeting !='')   
			    {
			         
			    
			   ?>
			       <a href="<?php echo $developer->StatutoryAnnualMeeting;?>"> <i class="fa fa-file-image-o" style="font-size:32px;"></i></a>
			   <?php
			    }
			    else
			    {
			   ...
			   <td>
			   <?php 
			    if($developer->YearlyMedicalExamination!='')   
			    {
			         
			    
			   ?>
			       <a href="<?php echo $developer->YearlyMedicalExamination;?>"> <i class="fa fa-file-image-o" style="font-size:32px;"></i></a>
			   <?php
			    }
			    else
			    {
			   ...
			   <td>
			   <?php 
			    if($developer->	LongTermAcademyDevelopmentProgram!='')   
			    {
			         
			    
			   ?>
			       <a href="<?php echo $developer->LongTermAcademyDevelopmentProgram;?>"> <i class="fa fa-file-image-o" style="font-size:32px;"></i></a>
			   <?php
			    }   
			    else
			    {
			   ...
			   <td>
			   <?php 
			    if($developer->ProofOfPayment !='')
			    {
			        
			    
			   ?>
			       <a href="<?php echo $developer->ProofOfPayment;?>"> <i class="fa fa-file-image-o" style="font-size:32px;"></i></a>
			   <?php
			    }
			    else
			    {
        ...
        <a href="takeaction.php?id=<?php echo $developer->Id; ?>">
