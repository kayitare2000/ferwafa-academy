...
?>
            ...
            <?php
            $i=1;
			$sql_query = "SELECT * FROM children WHERE Gender='$gender' AND AgeCategory LIKE '%Under " . $id . "%'"; 
			$resultset = $con->query($sql_query) or die("database error:". mysqli_error($con));
            $num_centres = $resultset->num_rows;
            ?>
                    <h1> <center><?php echo $gender;?> Under <?php echo $id; ?> Players (<?php echo $num_centres ?>) <center></h1>
			...
			?>
			   ...
			   <td><?php echo $developer->LastName; ?></td>
     		   ...
     		   ?>
     		    ...
     		    <p> N/A </p><a href="editplayer1.php?id=<?php echo $developer->Id;?>">click to attach </a>
     		 ...
     		 <?php
			   ...
			   <td><a href="editplayer1.php?id=<?php echo $developer->Id;?>"> 
				<button class="btn btn-warning">Edit</button> </a></td>

				<td><a href="transfer.php?id=<?php echo $developer->Id;?>"> 
...
?>
            ...
            <?php
            $i=1;
			$sql_query = "SELECT * FROM children "; 
			$resultset = $con->query($sql_query) or die("database error:". mysqli_error($con));
            $num_centres = $resultset->num_rows;
            ?>
                    <h1> <center>PLAYERS (<?php echo $num_centres ?>) <center></h1>
                <table id="example" class="table table-striped" style="width:100%">
                <thead>
            <tr>
                <th>Id</th>
