...
<body>
	...
	<div id="tg-wrapper" class="tg-wrapper tg-haslayout">
		...
		<main id="tg-main" class="tg-main tg-haslayout"style="padding-top:0px;margin-top:0px;">
			...
			<section class="tg-main-section tg-haslayout" style="margin:10px"> 
            <h4 style="margin:0px;padding:0px;color:green;"> <center> YOUR APPLICATION HAS BEEN SENT. Check your Email for further Details  <center></h4>
            </section>
