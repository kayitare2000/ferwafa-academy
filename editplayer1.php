...
if (isset($_POST['Submit'])) {
	...
	$sql = "Update children SET FirstName='$FirstName',Season='$Season', AgeCategory='$AgeCategory', LastName='$LastName',Gender='$Gender',FathersName='$FathersName', MothersName='$MothersName', DOB='$DOB', NID='$NID', Address='$Address',Position='$Position', Academy='$Academy', Telephone='$Telephone' WHERE Id='$Id' ";
...
?>
        ...
        <div class="col-md-3">
			  ...
			  <?php
			    $sql_query = "SELECT * FROM transfers WHERE PlayerId='$Id' ";
				$resultset = $con->query($sql_query) or die("database error:". mysqli_error($con));
				while( $developer = $resultset->fetch_object()) {
				?>  <tr>
                    <td> <?php echo $developer->Previous; ?></td>
					<td> <?php echo $developer->New; ?></td>  
