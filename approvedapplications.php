...
<body>
	...
	<div id="tg-wrapper" class="tg-wrapper tg-haslayout">
		...
		<main id="tg-main" class="tg-main tg-haslayout">
            ...
            <?php
            $i=1;
			$sql_query = "SELECT * FROM applications WHERE Status ='Approved' ";
			$resultset = $con->query($sql_query) or die("database error:". mysqli_error($con));
            $num_centres = $resultset->num_rows;
            ?>
                    <h1> <center>APPROVED APPLICATIONS (<?php echo $num_centres ?>) <center></h1>
       ...
       <tbody>
			...
			while( $developer = $resultset->fetch_object()) {
			    ...
			    $resultset_query1 = $con->query($sql_query_questions) or die("database error:". mysqli_error($con));
				$resultset_questions = $resultset_query1->fetch_object();
			?>
