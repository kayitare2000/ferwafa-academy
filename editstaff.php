...
?>
            ...
            <h1 style="margin:0px;padding:0px;"> <center>EDIT STAFF ACCOUNT <center></h1> 
				<div class="container">
                    <div class="row">
                    <form action="" Method="POST">    
                        <div class="col-md-6">
                            <label>UserName: </label>      
                            <input type="text" name="UserName" value="<?php echo $row['Username']; ?>" class="form-control" placeholder="Enter Center Name" required>
                            
                            <label>Email: </label>
                            <input type="email" name="Email"  value="<?php echo $row['Email']; ?>"class="form-control" required placeholder="Enter Email"> 
